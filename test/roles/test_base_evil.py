from src.resistance.role import BaseEvil
...
from src.resistance.util.constants import EVIL_TEAM_MEMBER


class TestBaseEvil:
    def test_name(self):
        r = BaseEvil()
        assert r.name == EVIL_TEAM_MEMBER
        assert str(r) == EVIL_TEAM_MEMBER
